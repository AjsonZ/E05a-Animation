...
# set the width, height, speed of the ball and title for screen
SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480
SCREEN_TITLE = "Move Keyboard Example"
MOVEMENT_SPEED = 3

# create a class called Ball and provide six arguments to it.
class Ball:
...
# create a class called MyGame and provide two arguments
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        arcade.set_background_color(arcade.color.ASH_GREY)  # set the background color as grey
    ...
    def on_key_release(self, key, modifiers):
        ...
        if key == arcade.key.LEFT or key == arcade.key.RIGHT:
            self.ball.change_x = 0                          # Confusing about this line. Why it's a zero?
