...
import arcade   #import the arcade module

# set the inital width, height and title for screen
SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480
...
# create a class called Mygame and provid two arguments.
class MyGame(arcade.Window):

    def __init__(self, width, height, title):       #initalize the class
        ...
        arcade.set_background_color(arcade.color.ASH_GREY)      # set the background
